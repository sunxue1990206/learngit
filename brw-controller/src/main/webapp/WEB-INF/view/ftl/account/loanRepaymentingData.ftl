<table id="table" cellpadding="0" cellspacing="0" width="100%">
	<tr class="f14">
    	<th class="wb15 wl ml15"><span>项目ID</span></th>
        <th class="wb15 wl pn"><span>发布时间</span></th>
        <th class="wb10 wr pn"><span>借款金额</span></th>
        <th class="wb10 wr pn" ><span>借款年利率</span></th>
        <th class="wb15" ><span>还款方式</span></th>
        <th class=" pn"><span>待还期数</span></th>
        <th class="wr wb12"><span>待还总额</span></th>
        <th ><span>操作</span></th>
    </tr>
    ...
    <#list obj as obj>
        ...
        <td class="wl pn" ><span>${obj.planPublishTime!}</span></td>
        ...
        <td class="pln"><span>${obj.resuidNumber!}</span></td>
        <td class="wr"><span>${obj.resuidAmount?string(",##0.00#")!}</span></td>
