				...
				<div id="connt_right" class="connt_right fr w938">
				    ...
				    <div class="right_div plr30" id="loanApplyBodyId">
					    <dl class="table_tab clearfix mt30 f14" id="loanRepayStatusId">
						    ...
						    <dd class="on_t fl"><a href="${rc.contextPath}/account/loanRepaymentClosed">已还清</a></dd>
...
<script src="${rc.contextPath}/resources/js/account/loanRepaymentClosed.js"></script>
</html>