    	...
    	<header>
         ...
         <div class="container">
        	<div class="w1160 mc clearfix">
        		<div class="fgray wb100 fl crumbs f12"><a class="fgray"  href="${Request["invControllerAddress"]}/index">首页</a>&nbsp;&gt;&nbsp;<a class="fgray"  href="${Request["userControllerAddress"]}/account/index">我的账户</a>&nbsp;&gt;&nbsp;<a class="fgray" href="${Request["brwControllerAddress"]}/account/loanApply">借款管理</a>&nbsp;&gt;&nbsp;借款申请 </div>
                <!--menu-->
                	<#include "*/common/menu.ftl" />
                <!--menu end-->
                <!--connt_right-->
				<div id="connt_right" class="connt_right fr w938">
					<h1 class="fpurple f18 fn right_title">借款申请<span class="fr f14 fgray mt10 mr20">单位：元</span></h1>
				    <!--right_div-->
				    <div class="right_div plr30" id="loanApplyBodyId">
				        <!--table_Search--select-->
				        <dl class="table_select clearfix mt30 f14">
							<dt class="clearfix fl">
								...
								<div f="112x36" class="focus_bg fl">
							            <div class="clearfix focus_div">
							                ...
							                <i class="account_icon date_icon fr">&nbsp;</i>
							            </div>
							    </div>
							    <span class="fl">--</span>
							    <div f="112x36" class="focus_bg fl">
							...
							<dd class="on_dd fl all" name="0"><a id="all" href="javascript:search(0)">全部</a></dd>
							...
							<input type="hidden" id="searchNumId" value="${searchNum!}" />
						</dl>
				        <!--table_select end-->
				         <!--table 资金明细-->
...
<script src="${rc.contextPath}/resources/js/account/loanApply.js"></script>
</html>