    ...
    c.ui.mouse = {
        ...
        _mouseDown: function(l) {
           ...
           if (!m || j || !this._mouseCapture(l)) {
            ...
            if (this._mouseDistanceMet(l) && this._mouseDelayMet(l)) {//bz0021
...
jQuery.effects || (function(d) {
    ...
    function Datepicker() {
        ...
        this._defaults = {
			...
			dateNotice:"date-notice",
			noticeWord:"结束时间不能小于开始时间"
        };
    ...
    $.extend(Datepicker.prototype, {
        ...
        _dialogDatepicker: function(input, dateText, onSelect, settings, pos) {
            ...
            extendRemove(inst.settings, settings || {});//bz03
        ...
        _checkOffset: function(inst, offset, isFixed) {
			...
			var l=inst.input ? inst.input.offset().top : 0;
			if(l>offset.top){offset.left=offset.left+inputWidth;}
            return offset
        },
        ...
        _hideDatepicker: function(input, duration) {//bz02
        ...
        _gotoToday: function(id) {
            ...
            if (this._get(inst, "gotoCurrent") && inst.currentDay) {
				...
				$.datepicker._selectDay(id,inst.drawMonth+1,inst.drawYear, $("#" + $.datepicker._mainDivId).find("a.ui-state-highlight").parent());			
            }
        ...
        iso8601Week: function(date) {
            ...
            var firstMon = new Date(checkDate.getFullYear(), 0, 4);
        ...
        _generateHTML: function(inst) {
			...
			var dateNotice=this._get(inst, "dateNotice");
			var noticeWord=this._get(inst, "noticeWord");
			var notice="<div id='"+dateNotice+"' class='"+dateNotice+" fred none wc'>"+noticeWord+"</div>";//bz00
            currentText = (!navigationAsDateFormat ? currentText: this.formatDate(currentText, gotoDate, this._getFormatConfig(inst)));
            var controls = (!inst.inline ? '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery.datepicker._hideDatepicker();">' + this._get(inst, "closeText") + "</button>": "");
            var buttonPanel = (showButtonPanel) ? '<div class="ui-datepicker-buttonpane ui-widget-content clearfix">' + (isRTL ? controls: "") + (this._isInRange(inst, gotoDate) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery.datepicker._gotoToday(\'#' + inst.id + "');\">" + currentText + "</button>": "") + (isRTL ? "": controls) + "</div>": "";
            ...
            html += buttonPanel +notice+ ($.browser.msie && parseInt($.browser.version, 10) < 7 && !inst.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>': "");
